...
start of the member every time. `urban_rag.role_foncier` makes the same two
...
Deliberately free of Dagster imports, mirroring `urban_rag.role_foncier`,
`urban_rag.bdoi` and `urban_rag.open_data`.
"""
...
def read_layer(
    ...
    *,
    ...
    `urban_rag.role_foncier.read_layer` gives.
    """
    try:
