...
zones it holds - see `hbu_dataplatform.quebec`; a Saguenay key snapshots the
municipal zoning layer with a grid link resolved per zone - see
`hbu_dataplatform.saguenay`. All three land under
...
from hbu_dataplatform.frames import (
    count_invalid_geometries,
    features_to_frame,
    table_slug,
    write_frame,
)
from hbu_dataplatform.infolot import esri_polygon
...
from hbu_dataplatform.saguenay import SaguenayZoningError
...
from hbu_dataplatform.spectrum import SpectrumError
from hbu_dataplatform.storage import (
    basename,
    clear_parquet,
    filesystem,
    join,
