...
Why this file is read at all, and what `CSALX02163` is, is in `hbu_dataplatform.rfu`.
"""
...
from hbu_dataplatform.partitions import City, MUNICIPALITY_CODES, date_partitions
