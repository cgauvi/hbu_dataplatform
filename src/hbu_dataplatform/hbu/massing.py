...
`hbu_dataplatform.hbu.program` answers in numbers - a footprint of 287 m2, five storeys,
...
from hbu_dataplatform.hbu.comparables import METRIC_CRS
...
def _surface_stall_area_m2() -> float:
    ...
    Read off `hbu_dataplatform.hbu.program` rather than restated, so the area this module
    ...
    """
    from hbu_dataplatform.hbu.program import M2_PER_SQFT, SURFACE_STALL_AREA_SQFT
