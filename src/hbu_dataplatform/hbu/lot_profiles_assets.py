...
`hbu_dataplatform.sources.roll.assets`, which is the join nobody publishes: Infolot draws the
...
`condo_band`. The other four stay in the object. `hbu_dataplatform.hbu.program` hardcodes
...
from hbu_dataplatform.sources.roll.assets import lot_assessed_values
...
def lot_profiles(
    ...
    return MaterializeResult(
        metadata={
            ...
            # in it. See `hbu_dataplatform.core.warehouse`.
