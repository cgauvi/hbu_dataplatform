...
biens-fonds* does, and `hbu_dataplatform.cubf_assets` snapshots it, so
...
from hbu_dataplatform.postgis import fetch_lots
...
from hbu_dataplatform.storage import clear_parquet, join, storage_options
...
#: Shared with `hbu_dataplatform.open_data_assets` rather than restated: both are
