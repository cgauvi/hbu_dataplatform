...
`hbu_dataplatform.role_assets`, which is the join nobody publishes: Infolot draws the
...
`condo_band`. The other four stay in the object. `hbu_dataplatform.program` hardcodes
...
from hbu_dataplatform.rag_assets import document_index
...
from hbu_dataplatform.role_assets import lot_assessed_values
...
def lot_profiles(
    ...
    return MaterializeResult(
        metadata={
            ...
            # in it. See `hbu_dataplatform.warehouse`.
