...
harvested into columns by `hbu_dataplatform.council_items`. Silver, because a
...
from hbu_dataplatform.council_items import read_document, read_minutes
...
from hbu_dataplatform.storage import dirname, filesystem, join, storage_options
...
@asset(
    ...
    description=(
        ...
        "hbu_dataplatform.council_items with its excerpt. Written to the tree and "
