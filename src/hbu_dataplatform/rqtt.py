...
start of the member every time. `hbu_dataplatform.role_foncier` makes the same two
...
Deliberately free of Dagster imports, mirroring `hbu_dataplatform.role_foncier`,
`hbu_dataplatform.bdoi` and `hbu_dataplatform.open_data`.
"""
...
def read_layer(
    ...
    *,
    ...
    `hbu_dataplatform.role_foncier.read_layer` gives.
    """
    try:
