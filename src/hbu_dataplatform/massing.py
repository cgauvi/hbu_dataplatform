...
`hbu_dataplatform.program` answers in numbers - a footprint of 287 m2, five storeys,
...
def _surface_stall_area_m2() -> float:
    ...
    Read off `hbu_dataplatform.program` rather than restated, so the area this module
    ...
    """
    from hbu_dataplatform.program import M2_PER_SQFT, SURFACE_STALL_AREA_SQFT
