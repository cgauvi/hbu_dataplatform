...
It is the companion to `hbu_dataplatform.sources.roll.assets.property_assessment_roll` in the
...
job - see `hbu_dataplatform.sources.cubf.client.use_code_descriptions` - and keeping the headings is
