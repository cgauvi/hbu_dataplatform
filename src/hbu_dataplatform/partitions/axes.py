...
#: partition, for `hbu_dataplatform.sources.cmhc.assets`. A third geography keyed the same
...
#: `hbu_dataplatform.cities.montreal.rents.assets` says so when it prices one off the Montreal market.
