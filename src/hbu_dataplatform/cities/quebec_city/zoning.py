...
grid that states its norms, and `hbu_dataplatform.zoning.zoning_grid` reads that PDF. Quebec
...
`QuebecZoningClient` reads the layer the way `hbu_dataplatform.sources.infolot.client.InfolotClient`
