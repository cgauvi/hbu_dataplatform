...
posture `hbu_dataplatform.sources.cmhc.client` takes toward a nation-wide survey: the slice is a
...
#: assets in `hbu_dataplatform.cities.montreal.costs.assets` are split; `institutional` and
