...
these in bronze; see the layer contract in `hbu_dataplatform.core.layers`. What the guide
publishes is published here unchanged, down to the storey band living inside
the label, as `hbu_dataplatform.cities.montreal.costs.estimator.rates_frame` explains.
"""
