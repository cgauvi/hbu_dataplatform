...
`hbu_dataplatform.core.postgis.load_streets`/`compute_lot_frontage` are Postgres-only in
...
from hbu_dataplatform.cadastre.frontage_assets import (
    LOT_FRONTAGE_FILE,
    ROAD_LOTS_FILE,
    lot_frontage,
)
...
def stub_postgis(
    ...
    *,
    ...
    for name, value in {
        ...
        monkeypatch.setattr(f"hbu_dataplatform.cadastre.frontage_assets.{name}", value)
    return calls
