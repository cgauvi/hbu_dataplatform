"""Offline tests for `hbu_dataplatform.hbu.massing` and the asset over it.
...
from hbu_dataplatform.hbu import massing, massing_assets
from hbu_dataplatform.hbu import program as program_module
...
from hbu_dataplatform.hbu.massing import MASSING_STATUSES, fit_rectangle
from hbu_dataplatform.hbu.massing_assets import LOT_MASSING_FILE, lot_building_massing
