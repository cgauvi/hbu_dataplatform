...
from hbu_dataplatform.core.warehouse import TABLES, Table
from hbu_dataplatform.core.postgis import MAP_CELL_COLUMNS
...
def test_every_column_the_map_cell_asset_writes_is_declared_by_its_file(infra):
    ...
    assert not missing, (
        f"hbu_dataplatform.core.postgis.MAP_CELL_COLUMNS writes {', '.join(missing)}, "
