...
city, and prints the literal to paste into `urban_rag.tile_cut`. It does
...
from urban_rag.partitions import city_of  # noqa: E402
...
def main() -> int:
    ...
    if dropped and not args.allow_recut:
        print(
            ...
            "urban_rag.tile_cut on what that costs. Re-run with --allow-recut "
